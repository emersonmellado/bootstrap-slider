      ...
      */
      ...
      _unbindJQueryEventHandlers: function() {
        ...
        this.$sliderElem.off();
			...
			_setHTMLText: function _setHTMLText(element, text) {
				if (typeof element.textContent !== "undefined") {
					element.innerHTML = text.replace(/\n\r?/g, '<br />');
					//Just to show on the right place :)
					element.parentElement.style.top = "-15px"; 
				}
			},			
			_setText: function _setText(element, text) {
				if (text.indexOf('\n')> 0){
					return this._setHTMLText(element, text);
				}
        if (typeof element.textContent !== "undefined") {
